...
# Creates an asset for the student files of this course based on the current state of this repo.
...
# APOpsOnPrem4.3_studentFiles_07may2020.zip
#
...
#
# Usage  : create-student-files-asset.sh [secure-props-key]  
# Example: create-student-files-asset.sh securePropsCryptoKey
...
assetname="$course$muleVersion""_studentFiles_$today" # APOpsOnPrem4.3_studentFiles_07may2020
assetfile="$assetname.zip"                            # APOpsOnPrem4.3_studentFiles_07may2020.zip
...
# module XY : FIXME
mkdir moduleXY
cp "$solutionsdir/standalone-apps/template-app/target/template-app"*.jar moduleXY/
# TODO
